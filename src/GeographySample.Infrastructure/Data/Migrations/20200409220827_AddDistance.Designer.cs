...
namespace GeographySample.Infrastructure.Migrations
{
    ...
    [Migration("20200409220827_AddDistance")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GeographySample.Core.Distance.GeoDistanceEntity", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("GeographySample.Core.User.UserEntity", b =>
                {
            ...
            modelBuilder.Entity("GeographySample.Core.Distance.GeoDistanceEntity", b =>
                {
                    b.HasOne("GeographySample.Core.User.UserEntity", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("GeographySample.Core.User.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
